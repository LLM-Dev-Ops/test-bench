...
impl GroqProvider {
    ...
    pub fn with_base_url(api_key: String, base_url: String) -> Result<Self, ProviderError> {
        ...
        let client = reqwest::Client::builder()
            .timeout(Duration::from_secs(60))  // Groq is faster
            .use_rustls_tls()
            .build()
...
impl Provider for GroqProvider {
    async fn complete(&self, request: CompletionRequest) -> Result<CompletionResponse, ProviderError> {
        ...
        let resp: GroqResponse = serde_json::from_str(&text)?;
    ...
    fn supported_models(&self) -> Vec<ModelInfo> {
        vec![
            ModelInfo::new("llama3-8b-8192", "Llama 3 8B", 8192, true, false),
            ModelInfo::new("llama3-70b-8192", "Llama 3 70B", 8192, true, false),
            ModelInfo::new("mixtral-8x7b-32768", "Mixtral 8x7B", 32768, true, false),
            ModelInfo::new("gemma-7b-it", "Gemma 7B", 8192, true, false),
        ]
    }

    fn max_context_length(&self, model: &str) -> Option<usize> {
        match model {
            "llama3-8b-8192" | "llama3-70b-8192" | "gemma-7b-it" => Some(8192),
