...
//! Perplexity AI provider implementation (OpenAI-compatible)
...
impl PerplexityProvider {
    pub fn new(api_key: String) -> Result<Self, ProviderError> {
        Self::with_base_url(api_key, "https://api.perplexity.ai".to_string())
    }
...
impl Provider for PerplexityProvider {
    async fn complete(&self, request: CompletionRequest) -> Result<CompletionResponse, ProviderError> {
        ...
        debug!("Sending request to Perplexity AI");
        ...
        if !response.status().is_success() {
            ...
            error!("Perplexity AI API error ({}): {}", status, text);
        ...
        let resp: PerplexityResponse = serde_json::from_str(&text)?;
    ...
    fn supported_models(&self) -> Vec<ModelInfo> {
        vec![
            ModelInfo::new("pplx-7b-chat", "Perplexity 7B Chat", 4096, true, false),
            ModelInfo::new("pplx-70b-chat", "Perplexity 70B Chat", 4096, true, false),
            ModelInfo::new("pplx-7b-online", "Perplexity 7B Online", 4096, true, false),
            ModelInfo::new("pplx-70b-online", "Perplexity 70B Online", 4096, true, false),
            ModelInfo::new("codellama-34b-instruct", "Code Llama 34B", 16384, true, false),
            ModelInfo::new("mistral-7b-instruct", "Mistral 7B", 4096, true, false),
            ModelInfo::new("mixtral-8x7b-instruct", "Mixtral 8x7B", 4096, true, false),
        ]
    }
